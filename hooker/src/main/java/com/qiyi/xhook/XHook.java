...
public class XHook {
    ...
    public synchronized boolean init(Context ctx) {
        ...
        try {
            ...
            try {
                ...
                ex.printStackTrace();
                Log.e("xhook:DexDump", "load libxhook.so failed");
            }
        }
        return inited;
    }
    ...
    public synchronized void refresh(boolean async) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.e("xhook:DexDump", "xhook native refresh failed");
        }
    }
    ...
    public synchronized void clear() {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.e("xhook:DexDump", "xhook native clear failed");
        }
    }
    ...
    public synchronized void enableDebug(boolean flag) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.e("xhook:DexDump", "xhook native enableDebug failed");
        }
    }
    ...
    public synchronized void enableSigSegvProtection(boolean flag) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.e("xhook:DexDump", "xhook native enableSigSegvProtection failed");
        }
    }
}
